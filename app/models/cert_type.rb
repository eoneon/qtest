class CertType < ApplicationRecord
  ...
  def inverso?
    properties["seal"] == "SOA inverso"
  end

  def na?
    properties["certificate"] == "N/A"
  end

  def join_seal_cert
    insert_rel_to_i(arr: category_names, pos: "after", i: "sealissuer", v: "and", occ: 0)
  end
  ...
  def key_loop
    cert_arr = seal_and_cert? ? join_seal_cert : category_names
